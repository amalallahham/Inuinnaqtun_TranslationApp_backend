...
//   ort = await import("onnxruntime-node").then((m) => m.default);
//   AutoTokenizer = (await import("@xenova/transformers")).AutoTokenizer;
// }
...
//     if (!ort || !AutoTokenizer) {
//       return res
//         .status(500)
//         .json({ error: "Translation model is not available in production." });
//     }
...
//   let input_ids = new ort.Tensor("int32", new Int32Array(inputIds), [
//     1,
//     inputIds.length,
//   ]);
//   let attention_mask = new ort.Tensor("int32", new Int32Array(inputMask), [
//     1,
//     inputIds.length,
//   ]);
...
//     let decoder_input_ids = new ort.Tensor(
//       "int32",
//       new Int32Array(decoderInputIdsArray),
//       [1, decoderInputIdsArray.length]
//     );
//     let decoder_attention_mask = new ort.Tensor(
//       "int32",
//       new Int32Array(decoderAttentionMaskArray),
//       [1, decoderAttentionMaskArray.length]
//     );
...
//     const predictedToken = extractPredictedToken(
//       results.logits.data,
//       vocabSize,
//       decoderInputIdsArray.length
//     );
...
//   try {
//     const decoded = await tokenizer.decode(input, {
...
//     (decoderInputIdsLength - 1) * vocabSize,
//     decoderInputIdsLength * vocabSize
//   );
